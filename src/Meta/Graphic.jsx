  ...
  return (
    <div>
      <div className="p-4 text-gray-600 bg-indigo-50 flex flex-col items-center justify-center h-200 text-accent">
        <h1 className="mb-20 text-center text-5xl font-bold text-accent">Graphic Designer:</h1>
        <ul className="flex place-content-center sm:grid-cols-2 gap-10 flex-wrap">
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Design Fundamentals</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Rang teoriyasi, tipografiya, compositisyon, visual hierarchy orqali chiroyli va samarali dizayn yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Adobe Creative Suite</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Photoshop, Illustrator, InDesign orqali professional grafik dizayn va layout yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              ...
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                User interface, user experience, wireframing, prototyping orqali foydalanuvchi-o'rientlangan dizayn yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Web Design</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Responsive design, web layout, CSS styling orqali veb uchun chiroyli dizayn yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Branding</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Logo design, brand identity, color palette, typography orqali kompaniya markasini yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Motion Graphics</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Animation, video editing, after effects orqali dinamik va taasiri kuchli video kontenti yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Illustration</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Vector illustration, digital painting orqali original va xalq bilan bog'lanuvchi tasvirlar yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Print Design</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Business cards, flyers, posters, brochures orqali print uchun dizayn yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Social Media Design</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Instagram, Facebook, TikTok uchun social media graphics yaratish va branding amalga oshiriladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Figma & Prototyping</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Figma, Sketch orqali collaborative design, prototyping va design systems yaratiladi.
              </p>
            </div>
          </li>
        </ul>

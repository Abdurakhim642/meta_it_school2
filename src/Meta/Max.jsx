  ...
  return (
    <div>
      <div className="p-4 text-gray-600 bg-indigo-50 flex flex-col items-center justify-center h-200 text-accent">
        <h1 className="mb-20 text-center text-5xl font-bold text-accent">Multimedia:</h1>
        <ul className="flex place-content-center sm:grid-cols-2 gap-10 flex-wrap">
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Audio Production</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Sound recording, mixing, mastering, DAW orqali professional audio yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Video Production</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Filming, editing, color grading, visual effects orqali professional video kontenti yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Animation</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                2D animation, 3D animation, motion graphics orqali animatsiyali kontenti yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Game Development</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Unity, Unreal Engine orqali interactive games va experiences yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Virtual Reality</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                VR development, 360 video, immersive experiences orqali virtual dunyolar yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Augmented Reality</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                AR applications, marker-based AR, location-based AR orqali real world bilan digital dunyo birlashtiriladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Web Multimedia</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                HTML5, WebGL, Canvas orqali interactive web multimedia experiences yaratiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Streaming Technology</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Live streaming, video compression, CDN orqali video kontenti tarqatiladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Podcast Production</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Recording, editing, distribution, promotion orqali podcast kontenti yaratish va tarqatish amalga oshiriladi.
              </p>
            </div>
          </li>
          <li className="flex">
            ...
            <div>
              <div className="text-3xl font-bold text-accent">Content Marketing</div>
              <p className="max-w-xs py-2 text-sm text-indigo-900">
                Strategy, SEO, analytics, social media promotion orqali multimedia kontenti bozorda muvaffaqiyatli oshkor qilinadi.
              </p>
            </div>
          </li>
        </ul>
